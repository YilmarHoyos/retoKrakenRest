...
public class CrearUsuarioStep {
	...
	@Step
	public void enviarOperacionCrearUsuario(String url, Map<String,String>cuerpo) {
		//se implementa el Map para que tome los datos desde el feature
	...
	@Step
	public void validarStatusDelServicio(int status) {
